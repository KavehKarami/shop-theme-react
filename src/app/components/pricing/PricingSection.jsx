...
const PricingSection = () => {
  return (
    <section className="container pt-3 mb-5 pricing-section d-flex justify-content-center align-items-center flex-wrap">
      <PricingCard imgURL="https://i.ibb.co/YXTWzVQ/bronze.png" title="لورم ایپسوم">
      ...
      <PricingCard isGold={true} imgURL="https://i.ibb.co/5v5VtTh/gold.png" title="لورم ایپسوم">
        <li>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ است.</li>
        <li>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ است.</li>
        <li>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ است.</li>
        <li>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ است.</li>
      ...
      <PricingCard imgURL="https://i.ibb.co/Ht9p6cb/silver.png" title="لورم ایپسوم">
        <li>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ است.</li>
        <li>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ است.</li>
        <li>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ است.</li>
        <li>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ است.</li>
